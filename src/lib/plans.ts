...
export function normalizePlan(plan?: string | null) {
  ...
  if (value === 'SEMESTRAL' || value === 'PRO' || value === 'PROFISSIONAL') return PLAN_CADERNOS_QUESTOES
...
export const PLAN_FEATURES: Record<string, string[]> = {
  ...
  [PLAN_CADERNOS_QUESTOES]: ['Dashboard', 'Minha Conta', 'Gerar questões', 'Plano de questões completo', 'Cadernos PDF', 'Edital Verticalizado', 'Meus Gerados', 'Suporte', '3.000 créditos', 'Acesso semestral'],
