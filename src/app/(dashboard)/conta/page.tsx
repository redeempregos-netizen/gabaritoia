...
export default function MinhaContaPage() {
  ...
  async function loadAccount() {
    ...
    try {
      ...
      setUser(data.user)
      setPlans((data.plans || []).filter((plan: PlanOption) => plan.id !== 'PACK'))
    ...
    <div className="p-4 md:p-6 max-w-6xl mx-auto space-y-6">
      ...
      <div className="card p-5">
        <div className="mb-4">
          ...
          <p className="text-xs text-zinc-500 mt-1">Os planos exibidos podem variar conforme sua assinatura.</p>
        </div>
