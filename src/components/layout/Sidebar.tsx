        ...
        <div className="mx-3 mt-2">
          <div className="bg-zinc-800/40 rounded-xl p-2.5">
            ...
            <button
              onClick={claimBonus}
              disabled={claiming}
              className="w-full py-1 rounded-lg bg-amber-500/10 border border-amber-500/20 text-amber-400 text-[10px] font-medium hover:bg-amber-500/20 transition-colors disabled:opacity-50"
            >
