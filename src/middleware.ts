...
export async function middleware(req: NextRequest) {
  ...
  // Evita loop: páginas públicas devem abrir mesmo quando existir cookie antigo/inconsistente.
  // A validação real acontece nas rotas protegidas e no layout do dashboard.
